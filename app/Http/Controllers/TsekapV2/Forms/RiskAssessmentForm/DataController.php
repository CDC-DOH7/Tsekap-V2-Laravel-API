...
class DataController extends Controller
{
    private function getAuthenticatedUser(?string $username): JsonResponse | User
    {
        ...
        if (!$queryUser || $queryUser->getAttribute('verified') !== 1) {
            Log::error('Denied access to (Risk Assessment, DataController) for:' . " " . $queryUser->getAttribute('id'));
    ...
    private function checkDuplicateEntries(?array $fields): bool
    {
    ...
    //---- !!! WORKING FUNCTION !!! ----//
    public function retrievePatientRiskProfileWithoutFacility(Request $request): JsonResponse
    {
        ...
        $query = RiskProfile::select(
            'risk_profile.id',
            'risk_profile.profile_id', //linked profile id from previous profiling
            'risk_profile.fname',
            'risk_profile.mname',
            'risk_profile.lname',
        ...
        if ($user->getAttribute('user_priv') === 3) {
            $query->where('risk_profile.province_id', $user->getAttribute('province'));
        }
    ...
    public function retrievePatientRiskProfileByFacility(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        $user = $this->getAuthenticatedUser($request->user()->getAttribute('username')); // This replaces Auth::check()
        if ($user instanceof JsonResponse) {
        ...
        if ($user->getAttribute('user_priv') === 3) {
            ...
            $query->where('risk_profile.facility_id_updated', $facility->getAttribute('id'));
        }
    ...
    public function retrievePatientRiskAssessment(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        $user = $this->getAuthenticatedUser($request->user()->getAttribute('username')); // This replaces Auth::check()
        if ($user instanceof JsonResponse) {
    ...
    public function addRiskProfile(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        ...
        try {
            ...
            return response()->json([
                ...
                'id' => $riskProfile->getAttribute('id')
            ], 200);
        } catch (Exception $e) {
    ...
    public function addRiskForm(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        $user = $this->getAuthenticatedUser($request->user()->getAttribute('username')); // This replaces Auth::check()
        if ($user instanceof JsonResponse) {
    ...
    // update the entire risk profile
    public function updateRiskProfile(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        $user = $this->getAuthenticatedUser($request->user()->getAttribute('username')); // This replaces Auth::check()
        if ($user instanceof JsonResponse) {
        ...
        $rules = [
            ...
            'fields.lname' => 'sometimes|nullable|string|max:255',
            'fields.fname' => 'sometimes|nullable|string|max:255',
            'fields.mname' => 'sometimes|nullable|string|max:255',
            'fields.suffix' => 'sometimes|nullable|string|max:10',
            'fields.sex' => 'sometimes|nullable|string|max:10',
            'fields.dob' => 'sometimes|nullable|date',
            'fields.age' => 'sometimes|nullable|integer|min:0|max:150',
            'fields.civil_status' => 'sometimes|nullable|string|max:20',
            'fields.religion' => 'sometimes|nullable|string|max:50',
            'fields.other_religion' => 'sometimes|nullable|string|max:50',
            'fields.contact' => 'sometimes|nullable|string|max:20',
            'fields.province_id' => 'sometimes|nullable|integer',
            'fields.municipal_id' => 'sometimes|nullable|integer',
            'fields.barangay_id' => 'sometimes|nullable|integer',
            'fields.street' => 'sometimes|nullable|string|max:255',
            'fields.purok' => 'sometimes|nullable|string|max:255',
            'fields.sitio' => 'sometimes|nullable|string|max:255',
            'fields.phic_id' => 'sometimes|nullable|string|max:20',
            'fields.pwd_id' => 'sometimes|nullable|string|max:20',
            'fields.citizenship' => 'sometimes|nullable|string|max:50',
            'fields.other_citizenship' => 'sometimes|nullable|string|max:50',
            'fields.indigenous_person' => 'sometimes|nullable|string|max:8',
            'fields.employment_status' => 'sometimes|nullable|string|max:50',
            'fields.facility_id_updated' => 'sometimes|nullable|integer',
            'fields.encoded_by' => 'sometimes|nullable|integer',
            'fields.offline_entry' => 'sometimes|nullable|boolean',
        ];
    ...
    // update risk form
    public function updateRiskForm(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
        $user = $this->getAuthenticatedUser($request->user()->getAttribute('username')); // This replaces Auth::check()
        if ($user instanceof JsonResponse) {
        ...
        $rules = [
            ...
            'fields.risk_profile_id' => 'required|integer',
            // ar
            'fields.ar_chest_pain' => 'sometimes|string|max:8',
            'fields.ar_difficulty_breathing' => 'sometimes|string|max:8',
            'fields.ar_loss_of_consciousness' => 'sometimes|string|max:8',
            'fields.ar_slurred_speech' => 'sometimes|string|max:8',
            'fields.ar_facial_asymmetry' => 'sometimes|string|max:8',
            'fields.ar_weakness_numbness' => 'sometimes|string|max:8',
            'fields.ar_disoriented' => 'sometimes|string|max:8',
            'fields.ar_chest_retractions' => 'sometimes|string|max:8',
            'fields.ar_seizure_convulsion' => 'sometimes|string|max:8',
            'fields.ar_act_self_harm_suicide' => 'sometimes|string|max:8',
            ...
            'fields.pmh_heart_disease' => 'sometimes|string|max:8',
            'fields.pmh_diabetes' => 'sometimes|string|max:8',
            'fields.pmh_specify_diabetes' => 'nullable|string|max:255',
            'fields.pmh_cancer' => 'sometimes|string|max:8',
            'fields.pmh_specify_cancer' => 'nullable|string|max:255',
            'fields.pmh_copd' => 'sometimes|string|max:8',
            'fields.pmh_asthma' => 'sometimes|string|max:8',
            'fields.pmh_allergies' => 'sometimes|string|max:8',
            'fields.pmh_specify_allergies' => 'nullable|string|max:255',
            'fields.pmh_mn_and_s_disorder' => 'sometimes|string|max:8',
            'fields.pmh_specify_mn_and_s_disorder' => 'nullable|string|max:255',
            'fields.pmh_vision_problems' => 'sometimes|string|max:8',
            'fields.pmh_previous_surgical' => 'sometimes|string|max:8',
            'fields.pmh_specify_previous_surgical' => 'nullable|string|max:255',
            'fields.pmh_thyroid_disorders' => 'sometimes|string|max:8',
            'fields.pmh_kidney_disorders' => 'sometimes|string|max:8',

            // fmh
            'fields.fmh_hypertension' => 'sometimes|string|max:20',
            'fields.fmh_stroke' => 'sometimes|string|max:20',
            'fields.fmh_heart_disease' => 'sometimes|string|max:20',
            'fields.fmh_diabetes_mellitus' => 'sometimes|string|max:20',
            'fields.fmh_asthma' => 'sometimes|string|max:20',
            'fields.fmh_cancer' => 'sometimes|string|max:20',
            'fields.fmh_kidney_disease' => 'sometimes|string|max:20',
            'fields.fmh_first_degree_relative' => 'sometimes|string|max:20',
            'fields.fmh_having_tuberculosis_5_years' => 'sometimes|string|max:20',
            'fields.fmh_mn_and_s_disorder' => 'sometimes|string|max:20',
            'fields.fmh_copd' => 'sometimes|string|max:20',

            // rf
            'fields.rf_tobacco_use' => 'sometimes|string|max:255',
            'fields.rf_alcohol_intake' => 'sometimes|string|max:8',
            'fields.rf_alcohol_binge_drinker' => 'sometimes|string|max:8',
            'fields.rf_physical_activity' => 'sometimes|string|max:8',
            'fields.rf_nutrition_dietary' => 'sometimes|string|max:8',
            'fields.rf_weight' => 'sometimes|numeric',
            'fields.rf_height' => 'sometimes|numeric',
            'fields.rf_body_mass' => 'sometimes|numeric',
            'fields.rf_waist_circumference' => 'sometimes|numeric',

            // rs
            'fields.rs_systolic_t1' => 'sometimes|numeric',
            'fields.rs_diastolic_t1' => 'sometimes|numeric',
            'fields.rs_systolic_t2' => 'sometimes|numeric',
            'fields.rs_diastolic_t2' => 'sometimes|numeric',
            'fields.rs_blood_sugar_fbs' => 'sometimes|nullable|numeric',
            'fields.rs_blood_sugar_rbs' => 'sometimes|nullable|numeric',
            'fields.rs_blood_sugar_date_taken' => 'sometimes|nullable|date',
            'fields.rs_blood_sugar_symptoms' => 'sometimes|nullable|string|max:255',
            'fields.rs_lipid_cholesterol' => 'sometimes|nullable|numeric',
            'fields.rs_lipid_hdl' => 'sometimes|nullable|numeric',
            'fields.rs_lipid_ldl' => 'sometimes|nullable|numeric',
            'fields.rs_lipid_vldl' => 'sometimes|nullable|numeric',
            'fields.rs_lipid_triglyceride' => 'sometimes|nullable|numeric',
            'fields.rs_lipid_date_taken' => 'sometimes|nullable|date',
            'fields.rs_urine_protein' => 'sometimes|nullable|numeric',
            'fields.rs_urine_protein_date_taken' => 'sometimes|nullable|date',
            'fields.rs_urine_ketones' => 'sometimes|nullable|numeric',
            'fields.rs_urine_ketones_date_taken' => 'sometimes|nullable|date',
            'fields.rs_chronic_respiratory_disease' => 'sometimes|nullable|string|max:255',
            'fields.rs_if_yes_any_symptoms' => 'sometimes|nullable|string|max:255',

            // mngm
            'fields.mngm_med_hypertension' => 'sometimes|nullable|string|max:8',
            'fields.mngm_med_hypertension_specify' => 'sometimes|nullable|string|max:255',
            'fields.mngm_med_diabetes' => 'sometimes|nullable|string|max:8',
    ...
    // delete risk profile
    public function deleteRiskProfile(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
    ...
    // delete risk form
    public function deleteRiskForm(Request $request): JsonResponse
    {
        // Ensure the user is authenticated via Sanctum
