...
class DataController extends Controller
{
    ...
    public function updateRiskProfile(Request $request)
    {
        ...
        $rules = [
            ...
            'fields.suffix' => 'sometimes|string|max:10',
            'fields.sex' => 'sometimes|string|max:10',
            'fields.dob' => 'sometimes|date',
            'fields.age' => 'sometimes|integer|min:0|max:150',
            'fields.civil_status' => 'sometimes|string|max:20',
            'fields.religion' => 'sometimes|string|max:50',
            'fields.other_religion' => 'sometimes|string|max:50',
            'fields.contact' => 'sometimes|string|max:20',
            'fields.province_id' => 'sometimes|integer',
            'fields.municipal_id' => 'sometimes|integer',
            'fields.barangay_id' => 'sometimes|integer',
            'fields.street' => 'sometimes|string|max:255',
            ...
            'fields.citizenship' => 'sometimes|string|max:50',
            'fields.other_citizenship' => 'sometimes|nullable|string|max:50',
            'fields.indigenous_person' => 'sometimes|string|max:8',
