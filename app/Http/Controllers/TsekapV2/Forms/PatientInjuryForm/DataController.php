...
class DataController extends Controller
{
    ...
    public function addPatientInjuryGeneralData(Request $request)
    {
        ...
        $rules = [
            ...
            'fields.age' => 'sometimes|nullable|numeric|min:0|max:120',
            'fields.age_in_months' => 'sometimes|nullable|numeric|min:0|max:12',
            'fields.age_in_days' => 'sometimes|nullable|numeric|min:0|max:31',
    ...
    public function addPatientInjuryPreadmissionData(Request $request)
    {
        ...
        $rules = [
            ...
            'fields.poi_time_of_injury' => 'required|string|max:20',
            'fields.date_of_consultation' => 'required|date',
            'fields.time_of_consultation' => 'required|string|max:20',
    ...
    public function updatePatientInjuryGeneralData(Request $request)
    {
        ...
        $rules = [
            ...
            'fields.age' => 'sometimes|nullabe|numeric|min:0|max:120',
            'fields.age_in_months' => 'sometimes|nullabe|numeric|min:0|max:12',
            'fields.age_in_days' => 'sometimes|nullabe|numeric|min:0|max:31',
    ...
    public function updatePatientInjuryPreadmissionData(Request $request)
    {
        ...
        $rules = [
            ...
            'fields.poi_time_of_injury' => 'sometimes|string|max:20',
            'fields.date_of_consultation' => 'sometimes|date',
            'fields.time_of_consultation' => 'sometimes|string|max:20',
