...
class DataController extends Controller
{
    ...
    public function addOneissPatientInjuryData(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'fields.noi_abradtl' => 'nullable|string|max:100',
            ...
            'fields.status_code' => 'nullable|string|max:10',
            'fields.mode_transport_code' => 'nullable|string|max:10',
            'fields.stat_reachdtl' => 'nullable|string|max:100',
            'fields.diagnosis' => 'nullable|string|max:100',
            'fields.icd_10_external_er' => 'nullable|string|max:10',
            'fields.icd_10_nature_er' => 'nullable|string|max:10',
            'fields.disposition_code' => 'nullable|string|max:10',
